...
import { ArrowRight, BookOpen, ShoppingBag, Users, Zap, Globe, Truck } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <motion.div 
                  ...
                  className="inline-flex items-center px-3 py-1 rounded-full bg-amber-100 text-amber-700 border border-amber-200 animate-pulse"
                >
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <motion.div 
              whileHover={{ y: -5 }}
              className="group p-8 text-center rounded-2xl border-0 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 hover:shadow-xl transition-all duration-300"
            >
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="group p-8 text-center rounded-2xl border-0 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 hover:shadow-xl transition-all duration-300"
            >
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="group p-8 text-center rounded-2xl border-0 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950 hover:shadow-xl transition-all duration-300"
            >
      ...
      <motion.section 
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-md py-12 mx-4"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-4xl font-display font-bold text-amber-600">10K+</p>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Books Available</p>
            </div>
            <div>
              <p className="text-4xl font-display font-bold text-amber-600">50+</p>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Countries Represented</p>
            </div>
            <div>
              <p className="text-4xl font-display font-bold text-amber-600">2K+</p>
              <p className="text-gray-600 dark:text-gray-300 mt-2">African Authors</p>
            </div>
            <div>
              <p className="text-4xl font-display font-bold text-amber-600">98%</p>
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Featured Books</h2>
            <p className="text-gray-600 dark:text-gray-300 mt-2">Curated selection of literary excellence from around the world</p>
          </div>
          <Button variant="outline" as={Link} to="/books" className="whitespace-nowrap">
            View All Books
          </Button>
        </div>
      ...
      <motion.section 
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="bg-white dark:bg-gray-950 rounded-2xl shadow-lg p-8 md:p-12 mx-4"
      >
        <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-12">Why Shop With Us</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <motion.div 
            whileHover={{ y: -5 }}
            className="text-center p-6 rounded-lg hover:shadow-md transition-all"
          >
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Free Delivery</h3>
            <p className="text-gray-600 dark:text-gray-300">Free delivery on orders over KES 2,000 within Nairobi</p>
          </motion.div>
          <motion.div 
            whileHover={{ y: -5 }}
            className="text-center p-6 rounded-lg hover:shadow-md transition-all"
          >
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">MPESA Payments</h3>
            <p className="text-gray-600 dark:text-gray-300">Secure and convenient MPESA payments with instant confirmation</p>
          </motion.div>
          <motion.div 
            whileHover={{ y: -5 }}
            className="text-center p-6 rounded-lg hover:shadow-md transition-all"
          >
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Global Selection</h3>
            <p className="text-gray-600 dark:text-gray-300">Thousands of titles from authors around the world</p>
          </motion.div>
        </div>
      </motion.section>
